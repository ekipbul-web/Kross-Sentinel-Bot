...
class TicketYonetim(discord.ui.View):
    ...
    async def ticket_close(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        # Yetki kontrolü - herkes kapatabilsin diye genişletildi
        is_ozel = ozel_rol_kontrol(interaction.user)
        ...
        # ============ ANA MANTIK ============
        # Eğer ticket'i alan bir yetkili varsa, PUANLAMA EKRANI GÖSTER
        if ticket.get("alan"):
            ...
            if yetkili and sahip:
                ...
                await interaction.channel.set_permissions(sahip, send_messages=False)
                ...
                puanlama_embed.set_footer(text="Puanlama yapılmazsa 5 dakika sonra otomatik kapanır")
                ...
                await interaction.response.send_message("✅ Ticket kilitlendi ve puanlama ekranı gösterildi.", ephemeral=True)
                return
        
        # Eğer ticket alınmamışsa direkt kapat
        await interaction.response.defer(ephemeral=True)
